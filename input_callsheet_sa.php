		...
		<div style="overflow:auto;width:auto;height:400px;border-top:1px solid #D0D0D0" >
		 <table width="90%">
                <tr align="center" bgcolor="#019273">
                        ...
                        <td width="5%"><font style="color:white;"><b>RETUR OUTLET</b></font></td>
                </tr>
                <?php
                ...
                <tr>
						...
						<td align="center">
						<?php 
						$sql2=$this->db->query("select sum(retur_outlet) as retur from tabel_callsheet_detil where id_callsheet_outlet='".$outlet['id_callsheet_outlet']."'");
						foreach($sql2->result_array() as $retur){
						if($retur['retur']==0){
						echo "0";
						} else {
						echo $retur['retur'];
